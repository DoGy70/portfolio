...
export const aboutMe =
  "Welcome to my website! My name is Miroslav. I am 20 years old,currently living in Sofia, Bulgaria, studying Computer andSoftware Engineering at Technical University - Sofia, second year. Programming has been my passion ever since I discovered video games and how they are created. My first steps into the vast programming world were accompanied by creating some basic 2D games with Unity. However, I slowly came to the conclusion that web development is much more interesting and important. In my opinion, making a beautiful and user-friendly web application that users will appreciate is a must for every company because it is the first interaction, and based on the application, the user will form their first impression. In addition, it is always exciting at the end when I can take a look the product that I have produced and get feedback from people to whom I show it. On this site, you will see some of the projects I have done during my learning. My main motivation is to start a new job where I can finally earn some real-life experience, learn new skills, and make new acquaintances in the software development industry.";
